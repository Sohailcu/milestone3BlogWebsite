...
const blogData = [
  {
    ...
    description:
      "Here’s a guide to assist you and your friends in preparing for and performing Umrah.",
  ...
  },
  {
    ...
    description:
      "Winter is the ideal time for Umrah, offering cooler weather and fewer crowds.",
  ...
  },
  {
    ...
    description:
      "Performing Umrah with children requires planning, patience, and flexibility.",
  ...
  },
  {
    ...
    description:
      "Finding affordable accommodation during Umrah can be challenging. Here's how to get the best deals while maintaining comfort and convenience.",
  ...
  },
  {
    ...
    description:
      "This article explores the best Umrah packages available during the sacred month of Rabi’ Al-Awal and how to choose the right one.",
  ...
  },
  {
    ...
    description:
      "These five tips will help ensure your Umrah journey is spiritually fulfilling and seamless from start to finish.",
  ...
  },
  {
    ...
    description:
      "Wondering how long Umrah takes? This guide gives you all the details on the duration of the rituals and the total time required for the pilgrimage.",
  ...
  },
  {
    ...
    description:
      "This article analyzes the growing trend of affordable Umrah packages and how travelers can benefit from them.",
  ...
  },
  {
    ...
    description:
      "Understand the prohibited items and practices while in Makkah for Umrah and ensure your pilgrimage complies with the sacred guidelines.",
...
function BlogSection() {
  ...
  // Calculate index of last post on current page and index of first post
  const indexOfLastPost = currentPage * postsPerPage;
  const indexOfFirstPost = indexOfLastPost - postsPerPage;
  const currentPosts = blogData.slice(indexOfFirstPost, indexOfLastPost);

  // Filter blogs based on the search query
  const filteredBlogs = currentPosts.filter(
    (blog) =>
      ...
      <section className="container mx-auto py-16 max-w-6xl">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mb-6 space-y-4 sm:space-y-0">
          ...
          <h4 className="text-sm font-semibold mb-6 sm:mb-0">
            Showing {indexOfFirstPost + 1} to {indexOfLastPost} of {blogData.length} posts
          </h4>
        ...
        <div className="flex justify-between items-center mt-8">
          <button
            className="text-gray-700 flex items-center hover:text-[#60d8ca]"
            ...
            {Array.from({ length: Math.ceil(blogData.length / postsPerPage) }, (_, index) => (
              <button
                ...
                className={`px-3 py-1 text-sm font-semibold ${
                  currentPage === index + 1 ? "text-white bg-[#60d8ca]" : "text-gray-700"
